                  ...
                  <div>
                    ...
                    <div className="mb-8 p-5 border border-gray-200 dark:border-gray-700 rounded-xl">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800 flex justify-between items-center">
                          <div>
                            <div className="font-medium text-gray-900 dark:text-white flex items-center">
                              Current Device
                              <span className="ml-2 px-2 py-0.5 text-xs bg-blue-100 dark:bg-blue-800 text-blue-800 dark:text-blue-300 rounded-full">
                                This device
                              </span>
                            </div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">Last active: Just now</div>
                          </div>
                        </div>

                        {/* Other Devices (Simulated) */}
                        <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 flex justify-between items-center">
                          <div>
                            <div className="font-medium text-gray-900 dark:text-white">iPhone 13 Pro • Safari</div>
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 flex justify-between items-center">
                          <div>
                            <div className="font-medium text-gray-900 dark:text-white">Windows PC • Chrome</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">Last active: Yesterday</div>
                          </div>
                          <button className="text-sm text-red-600 dark:text-red-400 hover:underline">Revoke</button>
                        </div>
                      </div>
                    ...
                    {/* Security Log */}
                    <div className="mb-8 p-5 border border-gray-200 dark:border-gray-700 rounded-xl">
                      <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Security Log</h3>
                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                      ...
                      <div className="space-y-4">
                        <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                          <div className="flex justify-between">
                            <div className="font-medium text-gray-900 dark:text-white">Password changed</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">2 weeks ago</div>
                          </div>
                          <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">From: Windows PC • Chrome</div>
                        </div>

                        <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                          <div className="flex justify-between">
                            <div className="font-medium text-gray-900 dark:text-white">Successful login</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">3 weeks ago</div>
                          </div>
                          <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            From: iPhone 13 Pro • Safari
                          </div>
                        </div>

                        <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                          <div className="flex justify-between">
                            <div className="font-medium text-gray-900 dark:text-white">Email address updated</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">1 month ago</div>
                          </div>
                          <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">From: Windows PC • Chrome</div>
                        </div>
                      </div>
